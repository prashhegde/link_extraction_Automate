...
from review_extraction.getlens1800 import *
from pathlib import Path
import os
from time import strptime

TAG = "www.1800getlens.com"
...
class GetLens1800():
    ...
    def extract_data(self, excel):
        wb = load_workbook(filename=PATH_INPUT + 'www.1800getlens.com.xlsx', read_only=True)
    ...
    def grab_reviews(self, excel, product_name, product_url):
        ...
        try:
            ...
            pass
        try:
            elements = self.driver.find_elements_by_xpath('//*[@class="product-review"]')
        except Exception as e:
...
wg = Excel("www.1800getlens.com") #correct
wb = getattr(wg, "wb")
lens = GetLens1800(driver, None)
lens.extract_data(wg)
while True:
    try:
        wg.save_xls(wb)
        Path("../status/" + "www.1800getlens.com" + ".txt").touch()
        break
    except:
        pass