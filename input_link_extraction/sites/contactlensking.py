            ...
            while True:
                ...
                try:
                    elements = self.driver.find_elements_by_xpath(
                        '//*[contains(@id,"groupContainer")]/div[contains(@class,"list")]')
    ...
    def get_data(self, div, excel, excel_dump):
        ...
        try:
            ...
            if content is not None:
                attributes.append("https://www.contactlensking.com/" + str(content.get("href")))
            else:
