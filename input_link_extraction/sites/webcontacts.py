...
class IWebContacts:
    def __init__(self, website, brands, excel, excel_dump, driver, logging, match_product_name, get_page, total_links):
        get_page(
            "https://www.clearly.com.au/contactlenses#sorting=featuredAnywhere-asc&page=0&searchFamily=contacts&categoryCode=Contacts&filterGroup=&pdi_=[]&widgetExpanded=false&perfectFitExpanded=false&requestIdentifier=64846&hotSpotsEnabled=true&order=[]")
        ...
        while True:
            ...
            try:
                elements = self.driver.find_elements_by_xpath(
                    '//*[contains(@class,"product-tile-container")]')
                if len(elements) < 1:
