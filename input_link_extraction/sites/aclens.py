...
class IAclens:
    def __init__(self, website, brands, excel, excel_dump, driver, match_product_name, get_page, total_links):
        ...
        for brand in self.brands:
            search_input = self.driver.find_element_by_xpath('/html/body/div[2]/header/div[1]/div[2]/div[2]/fieldset/div/form/div/span/label/input')
            search_input.clear()
    ...
    def get_data(self, div, excel, excel_dump):
        ...
        try:
            ...
            if content is not None:
                attributes.append("https://aclens.com" + str(content.get("href")))
            else:
