...
from input_link_extraction.sites.contactlensking import IContactLensKing
import threading
...
# Close chromedriver\
    ...
    def extract_data(self):
        ...
        website="www.contactlensking.com"
        ...
        IContactLensKing(website, self.brands, excel, excel_dump, self.driver, self.logging,self.match_product_name,self.get_page, self.total_links)
