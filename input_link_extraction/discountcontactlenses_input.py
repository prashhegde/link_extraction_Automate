...
from input_link_extraction.sites.discountcontactlenses import IDiscountContactLens
import threading
...
class LinkExtractor:
    ...
    def start_driver(self):
        ...
        try:
            driver = webdriver.Chrome("C:/Users/prash/Desktop/Work/scrapj-new/scrapj/input_link_extraction/utilities/drivers/chromedriver.exe")
        except:
            try:
                driver = webdriver.Chrome("C:/Users/prash/Desktop/Work/scrapj-new/scrapj/input_link_extraction/utilities/drivers/chromedriver")
            except:
                print("No Driver")
        sleep(4)
        return driver
...
# Close chromedriver\
    ...
    def extract_data(self):
        ...
        website="www.discountcontactlenses.com"
        ...
        if website.__contains__("discountcontactlenses"):
            IDiscountContactLens(website, self.brands, excel, excel_dump, self.driver, self.logging,self.match_product_name,self.get_page, self.total_links)
